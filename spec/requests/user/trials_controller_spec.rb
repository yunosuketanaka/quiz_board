  ...
  describe '#POST :create' do
    ...
    context 'if users_quizzes already does exist' do
      ...
      it 'redirects to questions show' do
        expect{:create_trial}.to redirect_to 'user/question/user/quizzes/1/questions/1'
      end
